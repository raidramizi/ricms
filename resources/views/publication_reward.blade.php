    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Publication Reward Application') }}
            </h2>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div style="max-width:800px; margin:0 auto; background: white; padding: 30px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
            ...
            <h3 style="margin-bottom:20px; font-size: 1.5rem; font-weight: 700; color: #1a202c;">
                Publication Reward Application Form
            </h3>
...
{{-- PRIMARY FILE UPLOAD --}}
                <div style="margin-bottom:25px; padding:20px; border:1px solid #e2e8f0; border-radius:8px; background: #ffffff;">

                    <small style="color: #718096; display: block; margin-bottom: 5px;">
                        Ensure the form includes Staff No and International Collaborator details (if any).
                    </small>
            ...
            {{-- INCENTIVE NOTE --}}
                <div style="margin-bottom:25px; padding:15px; background:#fffaf0; border: 1px solid #feebc8; border-radius:8px; display: flex; align-items: flex-start; gap: 10px;">
                    <span style="font-size: 1.2rem;"></span>
                    <small style="color: #744210;">
                        <strong>Incentive Note:</strong> International collaboration incentive of
                        <strong>RM 250 per country</strong> (maximum of 3 countries).
                    </small>
                </div>
