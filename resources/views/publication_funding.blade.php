...
<x-slot name="header">
    <div class="flex items-center gap-3">
        <button onclick="window.history.back()"
            class="px-3 py-1.5 bg-gray-100 hover:bg-gray-200 rounded-lg text-sm text-gray-700">
            ← Back
        </button>
...
<div class="py-12">
    <div style="max-width:800px; margin:0 auto; background:white; padding:30px; border-radius:12px; box-shadow:0 4px 6px rgba(0,0,0,0.1);">
        ...
        <h3 style="margin-bottom:20px; font-size:1.5rem; font-weight:700;">
            Publication Funding Application Form
        </h3>
